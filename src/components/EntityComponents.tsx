...
export const EntityHeader = ({title, description, newButtonLabel, newButtonHref, onNew, disabled, isCreating}: EntityHeaderProps) => {
  return (
  ...
  return (
    <div className='flex items-center justify-between gap-x-2 w-full'>
      ...
      <div className='flex items-center justify-end space-x-2 py-4'>
        <Button disabled={page === 1 || totalPages === 0 || disabled}
        variant='outline'
        size='sm'
