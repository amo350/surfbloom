...
export const ExecutionView = ({ executionId }: { executionId: string }) => {
  ...
  const duration = execution.completeAt
    ? Math.round(
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          {execution.completeAt ? (
            <div>
              ...
              <p className="text-sm">
                {formatDistanceToNow(execution.completeAt, { addSuffix: true })}
              </p>
            </div>
          ) : null}
          {duration !== null ? (
        ...
        {execution.errorStack && (
          <div className="col-span-2">
            <Collapsible open={showStackTrace} onOpenChange={setShowStackTrace}>
              ...
              <CollapsibleContent>
                <pre className="text-xs font-mono text-red-800 overflow-auto mt-2 p-2 bg-red-100 rounded w-full">
                  {execution.errorStack}
                </pre>
              </CollapsibleContent>
            </Collapsible>
